...
for i in range(5, 50):  # i是索引 x是值
    ...
    #print("k=" + str(i) + "时inertia_指标是：" + str(inertia))
    filename=open('std方法-silhouette(5-50).txt', 'a')
    ...
    #print("k=" + str(i) + "时Calinski-Harabase指标是：" + str(calinskiharabaszscore))

plt.figure(figsize=(15,8))
plt.plot(range(5,50),silhouettescore,linewidth=1.5,linestyle='-')
